            ...
            <div class="col-lg-3 col-sm-6 col-12  mb-2 mb-sm-3">
                <div class="footer-quick-links">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a class="footer-link" href="">About Us</a>
                        </li>
                        <li><a class="footer-link" href="">Products</a>
                        </li>
                        <li><a class="footer-link" href="">Careers</a>
                        </li>
                        <li><a class="footer-link" href="">Contact</a>
                        </li>
                    </ul>
                </div>
                        ...
                        <li>
                            <div class="media mb-3">
                                ...
                                <div class="media-body">
                                    ...
                                    <a class="" href="tel:+911146695760">+91 98989 98989</a>
                                </div>
                            </div>
                        </li>
                        <li>
